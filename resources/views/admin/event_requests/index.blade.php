                ...
                @forelse($events as $event)
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-xs text-gray-400 mt-1 truncate max-w-[150px] sm:max-w-xs">{{ $event->needs }}</div>
                        </td>
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-3 sm:px-6 py-4 text-right">
                            ...
                            @endif
                            <a href="{{ route('admin.event-requests.show', $event) }}" class="text-emerald-600 hover:text-emerald-800 font-bold text-xs uppercase tracking-tighter">Detail</a>
