...
<head>
    <meta charset="UTF-8">
    <title>Al-Aqsho Peduli Dispatch | Supported by Global Medical Care Indonesia</title>
...
<body class="bg-gradient-to-br from-slate-50 via-white to-slate-100 text-gray-800">
    ...
    <header class="bg-white/80 backdrop-blur border-b shadow-sm">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <img src="{{ asset('logo-al-aqsho.jpeg') }}" alt="Al-Aqsho Peduli Logo" class="h-10">
            </div>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="fade-up">
            <h1 class="text-4xl md:text-5xl font-extrabold leading-tight text-gray-900 mb-6">
                ...
                <span class="text-emerald-600">Al-Aqsho Peduli</span>
            </h1>
    ...
    <footer class="bg-slate-900 text-slate-300">
        <div class="max-w-7xl mx-auto px-6 py-8 text-center text-sm">
            © {{ date('Y') }} Al-Aqsho Peduli.<br>
            Supported by Global Medical Care Indonesia.<br>
            Sistem Dispatch Ambulans — Untuk Kemanusiaan.<br>
            <div class="mt-4 font-bold text-slate-100">Layanan 24 Jam: +0813-8328-0108 / 0857-1792-3717</div>
            <div class="mt-4">
