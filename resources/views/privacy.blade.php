        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8">
            ...
            <section>
                ...
                <div class="bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-r-lg">
                    <h3 class="font-bold text-emerald-800 mb-1 font-sm uppercase tracking-wider">Cara Mengajukan
                        Penghapusan:</h3>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-800 mb-3 underline decoration-emerald-500">2. Data yang Dihapus
                </h2>
                <p class="leading-relaxed text-gray-600">
                    Setelah permintaan diverifikasi, admin akan menghapus:
                </p>
                <ul class="list-disc list-inside mt-2 text-gray-600 space-y-1">
                    <li>Informasi profil pribadi (Nama, No HP).</li>
                    <li>Kredensial login (Email/Sandi).</li>
                    <li>Riwayat koordinat lokasi GPS terakhir.</li>
                </ul>
            </section>

            <section>
                <h2 class="text-xl font-bold text-gray-800 mb-3 underline decoration-emerald-500">3. Retensi Data</h2>
                <p class="leading-relaxed text-gray-600">
                    Sesuai dengan standar prosedur operasional medis dan hukum yang berlaku di Indonesia, data terkait
                    log penugasan (dispatch) dan riwayat penanganan pasien tetap disimpan dalam arsip internal kami
                    selama minimal 5 tahun sebagai data audit medis, namun identitas akun penggunanya akan dianonimkan
                    atau dihapus.
                </p>
            </section>

            <section>
                <h2 class="text-xl font-bold text-gray-800 mb-3 underline decoration-emerald-500">4. Hubungi Kami</h2>
                <p class="leading-relaxed text-gray-600">
                    Jika Anda memiliki pertanyaan mengenai penggunaan data Anda, silakan hubungi kantor operasional kami
                    di Jl. Tebet Barat Dalam Raya No.10, Jakarta Selatan.
                </p>
            </section>
        </div>
