    ...
    <form method="POST" action="<?php echo e(route('admin.dispatches.store')); ?>"
        ...
        <div>
            ...
            <select name="patient_condition" required class="w-full border rounded px-4 py-2">
                ...
                <option value="jenazah">⚰️ Jenazah</option>
            </select>
        </div>
        ...
        <div>
            ...
            <textarea name="pickup_address" required class="w-full border rounded px-4 py-2"></textarea>
        </div>

        <div>
            <label class="font-medium">Tujuan</label>
            <textarea name="destination" required class="w-full border rounded px-4 py-2"></textarea>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/ambulance-dispatch/resources/views/admin/dispatches/create.blade.php ENDPATH**/ ?>